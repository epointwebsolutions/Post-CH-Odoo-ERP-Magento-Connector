...
class Epoint_SwissPost_Api_Helper_Address extends Mage_Core_Helper_Abstract {
   ...
   */
  public function createUpdateAddress(Mage_Customer_Model_Customer $customer, Mage_Core_Model_Abstract $customerAddress){
    
    $address = new stdClass();
    // Share action
    Mage::dispatchEvent('swisspost_api_before_create_update_address',
                    		array(
                    			'customer'	=> $customer,
	...
	*/
    ...
    // Share action
    Mage::dispatchEvent('swisspost_api_after_create_update_address',
                    		array(
                    			'customer'	=> $customer,
                    			'customer_address'	=> $customerAddress,
                        	'address'	=> $address,
