...
class Epoint_SwissPost_Customer_Model_Address_Observer
{
    ...
    public function SwissPostApiBeforeCreateOrder(Varien_Event_Observer $observer)
    {
        ...
        if (Mage::helper('swisspost_customer/Address')->areSame(
     ...
     * @param Varien_Event_Observer $observer
     */
    public function SwissPostApiAfterCreateUpdateAddress(Varien_Event_Observer $observer)
    {
     ...
     * @param Varien_Event_Observer $observer
     */
    public function SwissPostApiBeforeCreateUpdateAddress(Varien_Event_Observer $observer)
    {
        $customer_address = $observer->getData('customer_address');
