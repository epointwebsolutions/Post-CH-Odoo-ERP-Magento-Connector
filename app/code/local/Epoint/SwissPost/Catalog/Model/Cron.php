...
class Epoint_SwissPost_Catalog_Model_Cron
{
    ...
    {
        try{
            if(!Mage::getStoreConfig(Epoint_SwissPost_Catalog_Helper_Data::XML_CONFIG_ENABLE_CRON_IMPORT_PRODUCTS)){
                return;
            }
            $options = array();
    ...
    {
        try {
            if(!Mage::getStoreConfig(Epoint_SwissPost_Catalog_Helper_Data::XML_CONFIG_ENABLE_CRON_IMPORT_CATEGORIES)){
                return;
            }
    ...
    public function getInventory()
    {
        try{
            ...
            if(!Mage::getStoreConfig(Epoint_SwissPost_Catalog_Helper_Data::XML_CONFIG_ENABLE_CRON_IMPORT_INVENTORY)){
                return;
            }
