...
$setup->addAttribute('catalog_product', 'ean13', array(
...
$setup->addAttribute('catalog_product', 'uom_name', array(
    'group' => 'Odoo Connector',
    'input' => 'text',
    'type' => 'text',
    'label' => 'UOM Name',
...
$setup->addAttribute('catalog_product', 'weight_net', array(
    'group' => 'Odoo Connector',
    'input' => 'text',
    'type' => 'text',
    'label' => 'Weight Net',
...
$setup->addAttribute('catalog_product', 'manufacturer_website', array(
    'group' => 'Odoo Connector',
    'input' => 'text',
    'type' => 'text',
...
$setup->addAttribute('catalog_product', 'sale_delay', array(
    'group' => 'Odoo Connector',
    'input' => 'text',
    'type' => 'int',
    'label' => 'Sale Delay',
