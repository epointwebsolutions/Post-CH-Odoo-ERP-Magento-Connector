	...
	*/
    ...
    public function send()
    {
      ...
      // All orders without odoo code id
  		...
  		->getCollection()
  		->addAttributeToFilter(Epoint_SwissPostSales_Helper_Data::ORDER_ATTRIBUTE_CODE_ODOO_ID , 
    			array(array('null' => true), 
    			array('eq'=>0)
  			)
  		)
  		->addAttributeToFilter(Epoint_SwissPostSales_Helper_Data::ORDER_ATTRIBUTE_CODE_ODOO_TIMESTAMP , 
    			array(array('null' => true), 
    			array('eq'=>0)
  			)
  		);
    ...
    public function receive(){
       ...
       // All orders without odoo code id
  		...
  		if($order_refs){
  		  $result = Mage::helper('swisspost_api/Order')->getPaymentStatus($order_refs);
  		}
    }
}
